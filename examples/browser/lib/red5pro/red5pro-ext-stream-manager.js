...
var modifyInitConfigWithResponse = function modifyInitConfigWithResponse(config, response, autoscaleConfig) {
  ...
  if (autoscaleConfig.useProxy && isRTC.test(config.protocol)) {
    (0, _log.debug)(NAME, '[modify-config]:: useProxy');
    var connParams = {
    ...
    c = (0, _extends3.default)({}, config, {
      ...
      app: 'streammanager',
      connectionParams: config.connectionParams ? (0, _extends3.default)({}, config.connectionParams, { connParams: connParams }) : connParams
    });
  } else {
    (0, _log.debug)(NAME, '[modify-config]:: Do Not useProxy');
    c = (0, _extends3.default)({}, config, {
      host: response.serverAddress,
      app: response.scope,
      streamName: response.name
